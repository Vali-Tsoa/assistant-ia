    ...
    <Draggable draggableId={task.id} index={index}>
      {(provided, snapshot) => (
        <div
          ...
          onClick={onClick}
          className={cn(
            "bg-background shrink-0 rounded-lg overflow-hidden border border-border cursor-pointer hover:border-primary/50 transition-colors",
            snapshot.isDragging && "shadow-lg ring-2 ring-primary/20 cursor-grabbing opacity-80 z-50"
          )}
